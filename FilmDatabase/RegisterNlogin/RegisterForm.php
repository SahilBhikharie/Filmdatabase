 ...
 if (mysqli_num_rows($result) > 0){
    ...
    if($password != $cpassword){
        $error[] = "Password not matched";
            ...
            $insert = "INSERT INTO admin(name, email, password, phonenumber) VALUES('$name','$email','$password','$$phonenumber') ";
...
<form action="" method="post" >
    ...
    <input type="text" name="phonenumber" required placeholder="Enter your phone number" >
        ...
        <p>Already have an account? <a href="LoginForum.php">Login here</a></p>
</form>
